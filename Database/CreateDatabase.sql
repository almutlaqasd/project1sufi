...
GO
INSERT INTO UserAccessRights (Name)
VALUES
('Adult'),
('Pediatric'),
('KACOLD');
...
GO
INSERT INTO DropdownMasters (Category, Name, SortOrder)
VALUES
('Type', 'Equipment', 1),
('Type', 'Safety', 2),
('Device', 'Echo', 1),
...
GO
CREATE TRIGGER TR_Users_UserActivityLog
ON Users
AFTER UPDATE, DELETE
AS
BEGIN
...
GO
CREATE TRIGGER TR_UserAccessRightMappings_ActivityLog
...
(
    ...
    EchoMachine NVARCHAR(100) NULL,
    ClinicalEngNumber VARCHAR(50) NULL,
    SerialNumber VARCHAR(100) NULL,
    PropertyTagNumber VARCHAR(100) NULL,
    AnnualPreventiveDueDate DATE NULL,
    Description NVARCHAR(MAX) NOT NULL,
    ImagePath NVARCHAR(500) NULL,
    Priority NVARCHAR(20) NOT NULL,
    ResolvedStatus NVARCHAR(50) NOT NULL DEFAULT 'pending',
    ResolvedOn DATETIME NULL,
    CONSTRAINT FK_FormResponses_Users_ReportedBy FOREIGN KEY (ReportedBy) REFERENCES Users(UserId) ON DELETE SET NULL
);
GO
INSERT INTO FormResponses (EmailAddress, ReporterName, Type, Device, Description, Priority, ResolvedStatus)
VALUES
(NULL, 'Sufiyan', 'Equipment', 'Echo', 'sdfd', 'High', 'Resolved'),
('almutlaqsd@gmail.com', 'Ibrahim', 'Safety', 'Echo', 'Not working', 'Low', 'pending'),
('sufiyanftd@gmail.com', 'Aaa', 'Equipment', 'Echo', 'Cc', 'Low', 'pending');
GO
